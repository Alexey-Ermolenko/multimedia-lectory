...
//ML_TODO: запись комманд, вывод видео с youtube
...
if ($video['file_src']) 
{
    ...
    YoutubeVideo::insertHTMLVideo($video['file_src'], '100%', '390');
...
<div class="modal fade right" id="save_lection_record_confirm_modal" tabindex="-1" role="dialog"
        ...
        <div class="modal-content">
            <div class="modal-body">
                <div class="row d-flex justify-content-center align-items-center">
                    ...
                    <a href="<?= Url::toRoute(['lections/view', 'id' => $id]) ?>" role="button"
                       class="btn btn-success waves-effect waves-light">Просмотреть
