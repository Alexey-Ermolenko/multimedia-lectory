...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-12">
            <h1 class="h1-responsive">Мультимедиа-лекторий | Создать сценарий</h1>
        </div>
    </div>
    <!--/.Page heading-->
    <hr>
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input name="data[name]" type="text" class="form-control" id="inputEmail4" placeholder="Название сценария">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="inputPassword4">Автор</label>
                        <input name="data[autor]" type="text" class="form-control" id="inputPassword4" placeholder="Автор">
                    </div>
                </div>
                <div class="form-group">
                    <div class="md-form">
                        <textarea name="data[description]" type="text" id="text2" placeholder="Описание сценария" class="md-textarea md-textarea-auto form-control" rows="2"></textarea>
